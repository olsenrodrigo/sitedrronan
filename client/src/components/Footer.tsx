      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div>
            ...
            <p className="text-base leading-relaxed mb-2" style={{ color: "#EDF2F4" }}>
              Dr. Ronan José Vieira Neto — Neurologista e Neuropediatra
            </p>
            <p className="text-sm leading-relaxed mb-1" style={{ color: "rgba(237, 242, 244, 0.7)" }}>
              Especialista em Neurologia Vascular, Neuropediatria e AVC.
            </p>
            ...
            <div className="grid grid-cols-2 gap-3 mt-4">
              ...
              <a href="https://www.instagram.com/emnhinstitutodemedicina/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-base transition-colors hover:text-white" style={{ color: "#EDF2F4" }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="mailto:contato@emnhinstituto.com.br" className="flex items-center gap-2 text-base transition-colors hover:text-white" style={{ color: "#EDF2F4" }}>
        ...
        <div className="border-t pt-8 text-center" style={{ borderColor: "rgba(237, 242, 244, 0.2)" }}>
          <p className="text-base flex items-center justify-center gap-2" style={{ color: "#EDF2F4" }}>
            ...
            &copy; {currentYear} Dr. Ronan Vieira. Todos os direitos reservados. Feito com
            <Heart size={16} className="fill-current" style={{ color: "#2A8FA8" }} />
          </p>
        </div>
      </div>
    </footer>
